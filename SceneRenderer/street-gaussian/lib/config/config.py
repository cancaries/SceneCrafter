...
# cfg.ply_model_path = "/root/DATA1/sim2real/agent_ply/picked"
cfg.ply_model_path = "../../demo/agent_ply/model_w_shadow"
cfg.scene_number = None
cfg.render_name = ""

parser = argparse.ArgumentParser()
parser.add_argument("--config", default="configs/default.yaml", type=str)
parser.add_argument("--ply_model_path", default="../../demo/agent_ply/model_w_shadow", type=str)
parser.add_argument("--scene_number", default=None, type=int)
parser.add_argument("--mode", type=str, default="")
parser.add_argument('--render_name', type=str, default="")
