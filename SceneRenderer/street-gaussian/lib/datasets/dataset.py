    ...
    def __init__(self, render_flag=False):
        ...
        if render_flag:
            for resolution_scale in cfg.resolution_scales:
                ...
                self.train_cameras[resolution_scale] = cameraList_from_camInfos(self.scene_info.train_cameras, resolution_scale, render_flag=render_flag)
                print("Loading Test Cameras")
                self.test_cameras[resolution_scale] = cameraList_from_camInfos(self.scene_info.test_cameras, resolution_scale, render_flag=render_flag)
        else:   
            for resolution_scale in cfg.resolution_scales:
                print("Loading Training Cameras")
